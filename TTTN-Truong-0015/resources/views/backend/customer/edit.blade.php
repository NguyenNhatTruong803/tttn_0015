...
@section('content')
    <section class="content">
        <div class="content-wrapper">
            ...
            <!-- Main content -->
            <section class="content">
                <form action="{{ route('customer.update', ['customer' => $customer->id]) }}" name="form1" method="post"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            <option value="1"
                                                {{ old('status', $customer->status) == 1 ? 'selected' : ' ' }}>Xuất bản</option>
                                            <option value="2"
                                                {{ old('status', $customer->status) == 2 ? 'selected' : ' ' }}>Không xuất bản
                                            </option>
                                        </select>
                                    </div>
                                </div>
